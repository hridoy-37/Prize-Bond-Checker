        ...
        {results && (
          ...
          >
            ...
            <button
              ...
              className={`w-full py-3 ${darkMode ? 'bg-gray-800 border-gray-600 text-gray-200 hover:bg-gray-700' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50'} border-2 rounded-lg font-semibold transition-all`}
            >
              Check Again
            </button>
          </div>
